...
class ProductsScreen extends StatelessWidget {
  static const name = 'products-screen';
  const ProductsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const AppBarShared(title: 'Lista de productos'),
      ...
      body: Container(
        ...
        child: const Padding(
          ...
          child: AnimatedListWidget(), // Usamos un widget de lista animada
        ),
      ),
    );
  }
                    ...
                    Row(
                      children: [
                        CircleAvatar(
                          ...
                          backgroundColor: Colors.white,
                          child: Icon(
                            Icons.local_florist, // Icono para actividades
                            size: 20,
